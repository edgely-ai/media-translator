...
export const JOB_STATE_TRANSITIONS: Readonly<Record<JobStatus, readonly JobStatus[]>> = {
  [JOB_STATE.CREATED]: [JOB_STATE.QUEUED, JOB_STATE.CANCELED],
  [JOB_STATE.QUEUED]: [JOB_STATE.NORMALIZING, JOB_STATE.CANCELED],
  [JOB_STATE.NORMALIZING]: [JOB_STATE.EXTRACTING_AUDIO, JOB_STATE.FAILED, JOB_STATE.CANCELED],
  [JOB_STATE.EXTRACTING_AUDIO]: [JOB_STATE.TRANSCRIBING, JOB_STATE.FAILED, JOB_STATE.CANCELED],
  [JOB_STATE.TRANSCRIBING]: [JOB_STATE.TRANSCRIPT_READY, JOB_STATE.FAILED, JOB_STATE.CANCELED],
  [JOB_STATE.TRANSCRIPT_READY]: [JOB_STATE.TRANSLATING, JOB_STATE.CANCELED],
